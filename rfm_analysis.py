...
Original file is located at
    https://colab.research.google.com/drive/1C2JIaHNxmWipdwHmPCZwY4NGJRN5EN2S
"""
...
# Calculate Recency
# 1. Access the date part of 'PurchaseDate' directly using `.dt.date` before subtraction.
# 2. After subtraction, it's a Timedelta Series, get days directly using `.dt.days`.
...
new_colors = px.colors.qualitative.Set2

# Create the bar chart with new colors
fig_segment_dist = px.bar(segment_counts, x='Value Segment', y='Count',
                          color='Value Segment', color_discrete_sequence=new_colors,
                          title='RFM Value Segment Distribution')
...
"""# Visualizing all the RFM Scores of all segments

Analyzing and visualizing the recency, frequency, and monetary scores of all the segments
"""
